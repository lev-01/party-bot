...
from texts import AVAILABLE_ALCOHOL_CATEGORIES, CHECK_TEXT, HELP_TEXT_ALCOHOL, AVAILABLE_ALCOHOL_MEASUREMENT_UNITS, FINAL_TEXT
import re
...
async def alco_step_1(message: types.Message):
    ...
    for category in AVAILABLE_ALCOHOL_CATEGORIES:
